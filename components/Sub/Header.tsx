  ...
  return (
    ...
    {menuOpen && (
      <motion.div 
        ...
        className='md:hidden flex flex-col items-center bg-white/60 rounded-lg shadow-lg p-4 mt-2'>
        <Link onClick={closeMenu} href='/about' className='font-normal p-2 text-sm hover:scale-105 duration-200 hover:font-bold cursor-pointer'>About</Link>
        <Link onClick={closeMenu} href='/portfolio' className='font-normal p-2 text-sm hover:scale-105 duration-200 hover:font-bold cursor-pointer'>Portfolio</Link>
        <Link onClick={closeMenu} href='/services' className='font-normal p-2 text-sm hover:scale-105 duration-200 hover:font-bold cursor-pointer'>Services</Link>
        <Link onClick={closeMenu} href='/contact' className='font-normal p-2 text-sm hover:scale-105 duration-200 hover:font-bold cursor-pointer'>Contact</Link>
      </motion.div>
    )}
  </div>
)
